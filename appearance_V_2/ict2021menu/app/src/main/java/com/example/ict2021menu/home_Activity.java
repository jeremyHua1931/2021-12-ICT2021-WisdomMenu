...
public class home_Activity extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.button_voice_2:
                    ...
                    Msg voice_result = new Msg(Hold_to_talk(),Msg.TYPE_RECEIVED);
                    msgList.add(voice_result);
    ...
    public String Hold_to_talk() {
        Msg msg_no = new Msg("正在处理中！",Msg.TYPE_RECEIVED);
        msgList.add(msg_no);
        //RecordtoFile();

        String tip="语音识别失败,请您返回主页面重新尝试";
        return tip;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        //ui线程操作主要在这里，TODO:在这里更改识别后对对话ui的处理
