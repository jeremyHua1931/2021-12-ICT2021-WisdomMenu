...
public class ImageViewLoadAndSetSizeAndCircle {
     ...
     *
     */
    public void setImage(ImageView imgView, String url, int width, int height, int CircleSize) {
        this.url = url;
    ...
    public Bitmap getUrlImage(String url) {
        ...
        img=zoomImage(img,this.width,this.height);
        return img;
    }
